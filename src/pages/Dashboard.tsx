  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto p-4 md:p-8">
        <h1 className="text-3xl font-semibold text-gray-900 mb-6">Overview Dashboard</h1>
        ...
        <div className="grid grid-cols-1 gap-6 
          ...
          <div className="sm:col-span-1 lg:col-span-1">
            <DataCard title="Total Users" size="small" type="summary" value="15,450" change="+2.5%" />
          </div>
