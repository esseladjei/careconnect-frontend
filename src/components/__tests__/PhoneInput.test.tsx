...
describe('PhoneInput Component', () => {
  ...
  it('shows operator info when valid MTN number is entered', async () => {
    userEvent.setup();
    render(
      <PhoneInput
        id="phone"
    ...
    // Operator info should display for valid MTN number
    const operatorText = screen.queryByText(/MTN Ghana/);
