      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-6 flex flex-col md:flex-row md:justify-between md:items-center text-sm text-gray-600">
          ...
          <div className="order-2 md:order-1 mt-4 md:mt-0">
            &copy; {new Date().getFullYear()} CareConnect, Product of KOADEL Connect of KOADEL Group.
              <a href="https://www.koadelgroup.com" target='_blank' className="hover:text-gray-900 transition-colors">
                <img src="/public/connect.png" alt="CareConnect Logo" className="inline-block h-auto w-30 ml-2"/>
              </a>
          </div>
          ...
          <div className="order-1 md:order-2 flex flex-wrap gap-x-4 gap-y-2">
            ...
            <div className="flex items-center space-x-2">
                ...
                <a href="#" className="flex items-center hover:text-gray-900 transition-colors">
                   <span className="mr-1">
                    <img src="/public/social/facebook.png" alt="Facebook" className="h-4 w-4"/>
                   </span>
                 Facebook
                </a>
                 ...
                 <a href="#" className="flex items-center hover:text-gray-900 transition-colors">
                    <span className="mr-1">
                        <img src="/public/social/instagram.png" alt="Instagram" className="h-4 w-4"/>
                    </span>
                   Instagram
                </a>
                 <a href="#" className="flex items-center hover:text-gray-900 transition-colors">
                    <span className="mr-1"><img src="/public/social/linkedin.png" alt="linkedIn" className="h-4 w-4"/></span>
                  LinkedIn
                </a>
                |
